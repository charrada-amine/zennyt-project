...
enum GameDirection {
  up(HugeIcons.strokeRoundedArrowUp02, 'haut', 'Up'),
  right(HugeIcons.strokeRoundedArrowRight02, 'droite', 'Right'),
  down(HugeIcons.strokeRoundedArrowDown02, 'bas', 'Down'),
  left(HugeIcons.strokeRoundedArrowLeft02, 'gauche', 'Left');
