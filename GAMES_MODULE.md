...
| Memory Quest — « J'investigue » | `MEMORY_QUEST` | Mémoire de travail | 🟡 **Missions A (Digit Span) + B (manipulation d'objets) jouables** — mobile, score mock ; distraction + backend à venir | Écran custom Flutter |
...
| « J'investigue » — phase de distraction | 🔴 À venir |
| « J'investigue » — backend (`MemoryQuestScoringService` + contrat + parité mock) | 🔴 À venir (mobile-mock d'abord) |
